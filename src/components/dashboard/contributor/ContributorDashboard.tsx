            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground font-medium mt-1">
                        Managing <span className="text-primary font-bold">5 active repositories</span> and your contribution pipeline.
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    <Button variant="outline" className="rounded-xl font-bold h-11 border-muted hover:bg-muted">
                ...
                <div className="lg:col-span-8 space-y-8">
                    <div className="bg-muted/30 rounded-[2rem] p-8 border border-muted-foreground/10">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <Button variant="link" className="text-primary font-black uppercase text-xs tracking-widest p-0">View Kanban</Button>
                        </div>
