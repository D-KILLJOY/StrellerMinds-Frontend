...
export const ProfileQuickView: React.FC<ProfileQuickViewProps> = ({ profile }) => {
    return (
            ...
            <CardContent className="pt-14 pb-6 px-6">
                ...
                <div className="mt-6 flex items-center justify-between p-3 bg-muted/40 rounded-2xl">
                    <div className="text-center px-2">
                        <p className="text-[10px] uppercase font-black text-muted-foreground/60 mb-1">Reputation</p>
                    ...
                    <div className="text-center px-2">
                        <p className="text-[10px] uppercase font-black text-muted-foreground/60 mb-1">Impact</p>
                ...
                <div className="mt-6 space-y-3">
                    <p className="text-xs font-black uppercase text-muted-foreground/60 tracking-widest">Top Skills</p>
                    <div className="flex flex-wrap gap-2">
                        {profile.skills.map((skill) => (
                            <Badge key={skill} variant="secondary" className="px-3 py-1 bg-primary/5 text-primary border-none font-bold text-[10px]">
                                {skill}
                            </Badge>
                        ))}
                    </div>
