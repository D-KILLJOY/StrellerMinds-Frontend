            ...
            <CardContent className="p-5">
                <div className="flex items-start justify-between mb-4">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground font-medium">{task.project}</p>
                    </div>
                    <Badge variant="outline" className={cn("rounded-lg font-bold", getPriorityColor(task.priority))}>
                        {task.priority}
                    </Badge>
                </div>
